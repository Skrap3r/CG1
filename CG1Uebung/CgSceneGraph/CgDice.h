...
class CgDice : public CgBaseTriangleMesh
{
...
public:
    ...
    const std::vector<CgPolyline*>& getNormals() const;
...
private:
    ...
    std::vector<CgPolyline*> m_normals;
...
inline Cg::ObjectType CgDice::getType() const {return m_type;}
inline unsigned int CgDice::getID() const {return m_id;}
